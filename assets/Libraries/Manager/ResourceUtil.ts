import { _decorator, Prefab, Node, SpriteComponent, SpriteFrame, ImageAsset, resources, error, Texture2D, instantiate, isValid, find, TextAsset, JsonAsset, Sprite, Rect, loader } from "cc";
 ...
 */
     ...
     * 根据英雄的文件名获取头像
     */
    public static setAvatar (avatarUrl: any, sprite: any, cb: any) {
        return;
    ...
    public static createEffect (path: any, cb: any, parent: any) {
        this.loadRes("/gamePackages/effects/" + path, Prefab, function (err: any, prefab: any) {
            if (err) {
                cb('err', null);
                return;
            }
    ...
    public static getEffectPrefab (path: any, callback: any) {
