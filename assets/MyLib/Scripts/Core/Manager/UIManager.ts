...
import { TextTip } from "../../GamePlay/UI/Tip/TextTip";
...
export class UIManager {
  ...
  private _showTipsAni(content: string, callback?: Function) {
    ResourceUtil.getUIPrefabRes("TextTip", function (err: any, prefab: any) {
      if (err) {
        return;
      }
      ...
      let tipScript = tipsNode.getComponent(TextTip) as TextTip;
